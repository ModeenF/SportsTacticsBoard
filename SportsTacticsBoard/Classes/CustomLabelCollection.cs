...
namespace SportsTacticsBoard
{
    ...
    public class CustomLabelCollection : ICollection<CustomLabel>
    {
        ...
        {
            if (dictionary != null && dictionary.TryGetValue(tag, out CustomLabel l))
            {
                return l.Label;
            }
        ...
        {
            if (dictionary.TryGetValue(tag, out CustomLabel l))
            {
                l.Label = customLabel;
            }
            else
        ...
        {
            if (item != null && dictionary.TryGetValue(item.Tag, out CustomLabel l))
            {

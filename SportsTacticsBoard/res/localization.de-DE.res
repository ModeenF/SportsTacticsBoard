...
MenuCopy: '&Kopieren ins Clipboard'
MenuCopyTooltip: Kopiert das aktuelle Layout in den Zwischenspeicher
MenuExit: B&eenden
MenuExport: Export als &Bilder...
MenuExportTooltip: Exportiert die aktuelle taktische Sequenz als Bildserie.
MenuHelp: '&Hilfe'
...
MenuLicense: '&Lizenz…...'
MenuNewSequence: '&Neu'
MenuOpenSequence: 'Ö&ffnen…'
MenuOptions: Op&tions
MenuPlayingSurface: '&Spielfeld'
MenuPrint: '&Drucken...'
MenuRemoveSavedLayout: '&Gelöschte gesichert...'
MenuResetView: Reset view
MenuSaveCurrentLayout: '&Aktuelles sichern…'
MenuSaveSequenceAs: 'Sichern &als...'
MenuSaveSequence: '&Sichern'
MenuSequence: '&Sequenz'
MenuUserSavedLayouts: '&Meine Anordnungen'
MenuSaveTofile: 'Exportiere als &Bild...'
MenuChangeLog: '&Änderungen...'
MenuReadMe: '&Lies Mich!...'
GoToFirst: Start
GoToLast: Ende
PreviousLayout: Vorherige
NextLayout: Nächste
PlayPause: &Abspielen/Pause
RecordNewPosition: Neue Aufnahme
RecordOverCurrentPosition: Neustart der aktuellen Aufnahme
RemoveCurrent: Lösche aktuelle Aufnahme
Repeat: Repeat
RevertCurrent: Rückgängig
ShowMovement: Zeige Bewegungen
Version: 'Version:'
...
NameLabel: '&Name:'
ChoseLanguageToolStripMenuItem: Sprache wählen
English: English:en-US
German: Englisch:de-DE
Swedish: Schwedisch:sv-SE
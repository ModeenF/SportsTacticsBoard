...
FieldTypeSoccer5: Soccer 5 * 5
FieldTypeSoccer7: Soccer 7 * 7
FieldTypeSoccer9: Soccer 9 * 9
...
MenuCopyTooltip: Copies the current layout to the clipboard
MenuExit: E&xit
...
MenuPlayingSurface: '&Playing Surface'
MenuPrint: '&Print...'
MenuRemoveSavedLayout: '&Remove saved...'
MenuResetView: Reset view
MenuSaveCurrentLayout: '&Save current...'
MenuSaveSequenceAs: 'Save &As...'
...
RecordNewPosition: Record New
RecordOverCurrentPosition: Record Over Current
RemoveCurrent: Remove Current
Repeat: Repeat
RevertCurrent: Revert Current
